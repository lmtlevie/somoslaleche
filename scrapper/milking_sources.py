...
with open('./sources.json') as f:
   ...
   scrap_milks_html(data["la_proveduria"],"//div[@class='products list']/div/div//div[@class='row']",".//h3/text()",".//div[@class='price']/text()",{"pager_xpath":"//div[@class='btn-group']","url_xpath":".//a/@href","host":"https://www.laproveeduria.ar"})
